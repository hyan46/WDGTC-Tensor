...
class WDGTC_CP:
    ...
    def fit(self, X, L_POI, L_NET, Omega):
        ...
        X_pred = tl.cp_to_tensor((Lambda, U))
        ...
        for epoch in range(self.max_iter):
            ...
            for r in range(R):
                ...
                Yr = Y - tl.cp_to_tensor((Lambda_xr,U_xr))
                ### Start condition 0 ###
                if Lambda[r] != 0:
                    #### Start of Loop-2 ####
                    ...
                    ### update Yr ###
                    Yr = Y - tl.cp_to_tensor((Lambda,U))# Yr = Yr - multi_outer_product(extraxt_r(U, r))
                else:
                    pass
                ### End condition 0 ###
            ## End of Loop-1 ##
            ...
            ## Update X_hat ##
            X_pred = tl.cp_to_tensor((Lambda,U))[np.nonzero(Omega)]
